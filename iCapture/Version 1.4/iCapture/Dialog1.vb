...
Public Class Dialog1
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        ...
        My.Forms.Capture.snapsLeft = NumericUpDown2.Value
    ...
    Private Sub Dialog1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim count As String = My.Computer.Registry.CurrentUser.OpenSubKey("Software\K15\iCapture\").GetValue("snapcount")
        If del <> "" Then
            NumericUpDown1.Value = Convert.ToInt16(del) / 1000
        End If
        If count <> "" Then
            NumericUpDown2.Value = Convert.ToInt16(count)
        End If
    End Sub
